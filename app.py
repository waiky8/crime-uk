...
with open('house.png', 'rb') as f:
    image_house = base64.b64encode(f.read())
with open('car.png', 'rb') as f:
    image_car = base64.b64encode(f.read())
with open('robbery.png', 'rb') as f:
    image_robbery = base64.b64encode(f.read())
with open('violence.png', 'rb') as f:
    image_violence = base64.b64encode(f.read())
with open('theft.png', 'rb') as f:
    image_theft = base64.b64encode(f.read())
with open('others.png', 'rb') as f:
    image_others = base64.b64encode(f.read())
